                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type='file' class="@error('profile_img') is-invalid @enderror" name="profile_img"/>
                                @error('profile_img')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <form method="POST" enctype='multipart/form-data'>
                            ...
                            <div class="row">
                                ...
                                <label for="profile_image">Profile Picture</label>
                                    <div>
                                        <img id="profileimage" class="profileimg"/>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    ...
                                    <input id="address" type="address"  class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" autofocus>
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                  ...
                                  <span toggle="#password-confirm" class="fa fa-fw fa-eye-slash fa-lg field-icon toggle-confirmpassword"></span>
                                </div>
                            </div>
